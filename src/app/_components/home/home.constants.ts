export const FAQ_ITEMS = [
  ...
  {
    id: "home-faq-3",
    question: "איך אתם עוזרים לעסק להופיע בגוגל?",
    answer:
      "אנחנו מבצעים Search Optimization הכולל מחקר מילות מפתח, שיפור מבנה האתר, יצירת תוכן נכון, אופטימיזציה טכנית ובניית דפים שמביאים תנועה. המטרה היא לגרום לעסק שלך להופיע כאשר לקוחות מחפשים את השירותים שאתה מציע.",
  },
  {
    id: "home-faq-4",
  ...
  {
    id: "home-faq-5",
    question: "האם אתם גם בונים את האתר או רק מקדמים אותו?",
    answer:
      "כן. אנחנו מתמחים גם בפיתוח אתרים ומערכות. אנחנו בונים אתרים מהירים, מאובטחים ומותאמים למנועי חיפוש ול-AI, כך שקל יותר לקדם אותם ולהביא לקוחות חדשים.",
  },
  {
    id: "home-faq-6",
    question: "כמה זמן לוקח לראות תוצאות מקידום אורגני?",
    answer:
      "ברוב המקרים ניתן לראות תנועה ראשונית תוך מספר חודשים. התוצאות תלויות בתחום, בתחרות ובמצב האתר. המטרה שלנו היא לבנות נוכחות יציבה שמביאה לקוחות לאורך זמן.",
  },
  {
    id: "home-faq-7",
