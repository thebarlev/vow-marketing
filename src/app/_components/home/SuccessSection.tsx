    ...
    <section aria-label="הצלחה" className="py-[var(--space-section)]">
      <div className="mx-auto max-w-[1440px] px-4 sm:px-6 lg:px-0">
        <div className="space-y-6">
          ...
          <p className="mx-auto max-w-3xl text-center text-[18px] font-semibold leading-[26px] text-[color:var(--vow-muted)] sm:text-[22px] sm:leading-[30px] lg:text-[26px] lg:leading-[32px]">
