...
const FAQ_ITEMS: readonly FaqItem[] = [
  ...
  },
  {
    ...
    answer: "כן. בנוסף לרו״ח AI, קיים מסלול הכולל רואה חשבון או יועץ מס אנושי, שיכול ללוות ולתת מענה אישי בעת הצורך.",
  },
  {
    question: "האם שירות רו״ח AI חוקי?",
    answer: (
      <>
        החוק בישראל מאפשר לבעלי עסקים (עוסק פטור / עוסק מורשה) להגיש דוחות חודשיים ושנתיים בעצמם.
        <br />
        <br />
        לכן בנינו את רו״ח ה-AI של VOW: הוא מנחה אותך שלב-אחר-שלב, מכין עבורך את רוב העבודה בצורה מדויקת ובהתאם לתקנות — ואתה רק מאשר ולוחץ.
        <br />
        <br />
  ...
  {
    question: "האם רו״ח AI מחליף רואה חשבון?",
    answer: "לא בהכרח. בשביל זה יש לנו רו״ח שילוו אתכם. רו״ח AI נועד לפשט, לייעל ולמנוע טעויות, והוא יכול לעבוד לבד או בשילוב עם רו״ח / יועץ מס אנושי – לפי הצורך שלך.",
  },
  {
    question: "איך רו״ח AI מכיר את העסק שלי?",
    answer: (
      <>
        רו״ח ה-AI של VOW פועל לפי התקנות והספרים של מס הכנסה, ביטוח לאומי ומע״מ.
        <br />
        <br />
  ...
  },
  {
    ...
    answer: (
      <>
        הרו״ח עובד בשבילך 24/7, זמין לכל שאלה ונותן לך תשובה רק מתוך המידע של מס הכנסה, ביטוח לאומי ומע״מ.
        <br />
        <br />
