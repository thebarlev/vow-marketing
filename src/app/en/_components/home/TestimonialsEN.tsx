...
import { TESTIMONIALS_EN } from "./homeEn.constants"

export function TestimonialsEN() {
  return (
    <section aria-label="Testimonials" className="py-3 bg-[#F4F1EC]">
