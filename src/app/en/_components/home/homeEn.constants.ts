...
export const OUR_PACKAGES_EN = [
  ...
  },
  {
    ...
    kicker: "Technology that powers your growth",
    buttonLabel: "Get in touch",
    bullets: [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Structured content AI engines",
      "SEO and AI visibility combined",
      "Continuous optimization",
      "More traffic. More qualified leads.",
    ],
...
export const ABOUT_US_EN = [
  {
    title: "Save with smart AI development",
    kicker: "Precise specs and advanced AI tools reduce errors, shortcuts, and costly revision rounds.",
    icon: "/about/1.svg",
  },
  {
    title: "Fewer errors. Less waste. More results.",
    kicker: "AI-driven process lets us plan right from the start-no budget burned on trial and error.",
    icon: "/about/2.svg",
  },
  {
    title: "Speed without compromising quality",
    kicker: "Accurate planning, smart AI use, and structured workflow cut delays and shorten the path to results.",
    icon: "/about/3.svg",
  },
] as const
...
export const GREEN_INVOICE_BENEFITS_EN = [
  "Visible in ChatGPT and Gemini answers.",
  "Higher Google rankings without paid campaigns.",
  "Advanced tools + dedicated expert for your business.",
  "More visibility, more customers.",
  "Personal expert support, not a bot.",
] as const
