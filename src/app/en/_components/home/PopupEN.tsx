    ...
    source === "smart_accounting_ai" ? (
      <>
        <p className="text-[22px] font-semibold text-[#5389BB]">
          The pilot quota (100 businesses) is full.
        </p>
        <p className="text-[22px] font-semibold leading-relaxed text-[#747474]">
          We&apos;ll open new spots soon and reach out to update you.
        </p>
      </>
    ) : (
      <p className="text-[22px] font-semibold leading-relaxed text-[#747474]">
  ...
  return (
    ...
    >
      <div className="flex min-h-full items-start justify-center py-10">
        <div
          className="relative w-full max-w-[637px] rounded-xl bg-white p-5 text-left"
          dir="ltr"
        ...
        >
          <button
            ...
            onClick={onClose}
            aria-label="Close"
            className="absolute top-4 right-4 flex h-8 w-8 items-center justify-center rounded-full text-gray-400 hover:bg-gray-100 hover:text-black transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-300"
          >
          ...
          {!isSuccess ? (
            ...
            <div className="mx-auto max-w-[520px] space-y-6 text-center">
              ...
              <h2 className="text-[40px] font-bold">Request received successfully</h2>
